...
typedef CommandDeserializerCallback = Command Function(Map<String, String> params, DeserializeFinderFactory finderFactory);
...
@immutable
class FinderConfig {
  /// Creates an finder config.
  const FinderConfig({this.deserialize, this.constructor});

  /// Deserializes the finder from JSON generated by [SerializableFinder.serialize].
  final DeserializeFinder deserialize;

/// run the given finder and return the [Element]
/// found, if any, or null otherwise.
  final FinderConstructor constructor;
}
...
class FlutterDriverExtension {
  ...
  FlutterDriverExtension(this._requestDataHandler, this._silenceErrors, Map<String, FinderConfig> finders) {
    ...
    _commandDeserializers.addAll(<String, CommandDeserializerCallback>{
      'get_health': (Map<String, String> params, DeserializeFinderFactory finderFactory) => GetHealth.deserialize(params),
      'get_layer_tree': (Map<String, String> params, DeserializeFinderFactory finderFactory) => GetLayerTree.deserialize(params),
      'get_render_tree': (Map<String, String> params, DeserializeFinderFactory finderFactory) => GetRenderTree.deserialize(params),
      'enter_text': (Map<String, String> params, DeserializeFinderFactory finderFactory) => EnterText.deserialize(params),
      'get_text': (Map<String, String> params, DeserializeFinderFactory finderFactory) => GetText.deserialize(params, finderFactory),
      'request_data': (Map<String, String> params, DeserializeFinderFactory finderFactory) => RequestData.deserialize(params),
      'scroll': (Map<String, String> params, DeserializeFinderFactory finderFactory) => Scroll.deserialize(params, finderFactory),
      'scrollIntoView': (Map<String, String> params, DeserializeFinderFactory finderFactory) => ScrollIntoView.deserialize(params, finderFactory),
      'set_frame_sync': (Map<String, String> params, DeserializeFinderFactory finderFactory) => SetFrameSync.deserialize(params),
      'set_semantics': (Map<String, String> params, DeserializeFinderFactory finderFactory) => SetSemantics.deserialize(params),
      'set_text_entry_emulation': (Map<String, String> params, DeserializeFinderFactory finderFactory) => SetTextEntryEmulation.deserialize(params),
      'tap': (Map<String, String> params, DeserializeFinderFactory finderFactory) => Tap.deserialize(params, finderFactory),
    ...
    _finders.addAll(<String, FinderConfig>{
      'ByText': FinderConfig(
        constructor: (SerializableFinder finder) => _createByTextFinder(finder as ByText),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => ByText.deserialize(json)
      ),
      'ByTooltipMessage': FinderConfig(
        constructor: (SerializableFinder finder) => _createByTooltipMessageFinder(finder as ByTooltipMessage),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => ByTooltipMessage.deserialize(json)
      ),
      'BySemanticsLabel': FinderConfig(
        constructor: (SerializableFinder finder) => _createBySemanticsLabelFinder(finder as BySemanticsLabel),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => BySemanticsLabel.deserialize(json)
      ),
      'ByValueKey': FinderConfig(
        constructor: (SerializableFinder finder) => _createByValueKeyFinder(finder as ByValueKey),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => ByValueKey.deserialize(json)
      ),
      'ByType': FinderConfig(
        constructor: (SerializableFinder finder) => _createByTypeFinder(finder as ByType),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => ByType.deserialize(json)
      ),
      'PageBack': FinderConfig(
        constructor: (SerializableFinder finder) => _createPageBackFinder(),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => const PageBack()
      ),
      'Ancestor': FinderConfig(
        constructor: (SerializableFinder finder) => _createAncestorFinder(finder as Ancestor),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => Ancestor.deserialize(json, finderFactory)
      ),
      'Descendant': FinderConfig(
        constructor: (SerializableFinder finder) => _createDescendantFinder(finder as Descendant),
        deserialize: (Map<String, String> json, DeserializeFinderFactory finderFactory) => Descendant.deserialize(json, finderFactory)
      )
    });

    _finders.addAll(finders);
  }
  ...
  final Map<String, FinderConfig> _finders = <String, FinderConfig>{};
  ...
  Future<Map<String, dynamic>> call(Map<String, String> params) async {
    ...
    try {
      ...
      final Command command = commandDeserializer(params, _finderFactory);
  ...
  SerializableFinder _finderFactory(Map<String, String> json){
    ...
    if (_finders.containsKey(finderType)) {
      return _finders[finderType].deserialize(json, (Map<String, String> json) => _finderFactory(json));
    } else {
