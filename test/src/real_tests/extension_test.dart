...
void main() {
  group('waitUntilNoTransientCallbacks', () {
    ...
    setUp(() {
      result = null;
      extension = FlutterDriverExtension((String message) async { log.add(message); return (messageId += 1).toString(); }, false, <String, FinderConfig>{});
    });
  ...
  group('getSemanticsId', () {
    FlutterDriverExtension extension;
    setUp(() {
      extension = FlutterDriverExtension((String arg) async => '', true, <String, FinderConfig>{});
    });
  ...
  testWidgets('getOffset', (WidgetTester tester) async {
    final FlutterDriverExtension extension = FlutterDriverExtension((String arg) async => '', true, <String, FinderConfig>{});
